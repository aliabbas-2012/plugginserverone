...
<div class="row-fluid">
    <div class="span3">
        <div class="sidebar-nav">
            ...
            $this->widget('zii.widgets.CMenu', array(
                ...
                'encodeLabel' => false,
                'items' => array(
                    array('label' => '<i class="icon icon-home"></i>  Home <span class="label label-info pull-right"></span>', 'url' => array('/web/default/index'), 'itemOptions' => array('class' => '')),
  ...
  <!--            <tr>
    ...
    <div class="span9">
        ...
        } else if (Yii::app()->user->hasFlash("error_array")) {
            $errors = Yii::app()->user->getFlash("error_array");
