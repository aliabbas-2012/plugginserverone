...
<a href="<?php echo $this->createAbsoluteUrl('/web/users/login',array('url'=>$pluggin_site->site_name,'pluggin'=>$pluggin_site->plugin->name)); ?>" target="_blank"  title="Click to Sign In">Sing In</a>