<link rel="stylesheet" href="<?php  echo Yii::app()->theme->baseUrl; ?>/css/layerslider.css" type="text/css">
        <link rel="stylesheet" href="<?php  echo Yii::app()->theme->baseUrl; ?>/css/slider-style.css" type="text/css">
        <!--[if lt IE 9]>
            <script src="../assets/js/html5.js"></script>
        <![endif]-->
    <link rel="stylesheet" href="<?php  echo Yii::app()->theme->baseUrl; ?>/sliderlayer/skin.css" type="text/css"></head>
...
<div id="layerslider-container">
            ...
            <div id="layerslider" style="width: 1280px; height: 358px; margin: 0 auto;">
            	
                <div class="ls-layer" style="slidedelay: 1500; transition2d: 24,25,27,28,34,35,37,38,110,113;">
                ...
                <div class="ls-layer" style="slidedelay: 2500; transition2d: 11; background:#e34040;">

                    <img class="ls-s-1" src="<?php  echo Yii::app()->theme->baseUrl; ?>/sliderlayer/tucan.png" alt="Tucan" style="top: 31px; left: 324px; slidedirection : right; slideoutdirection : bottom; durationin : 4000; easingin : easeOutQuart; rotatein : 20; rotateout : -10; scalein : 1.2; ">
...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active item-1 img-item">
            <div class="container">
                <div class="carousel-caption-1">
                </div>
            </div>
        </div>
        <div class="item item-2 img-item">
            <div class="carousel-caption-2">
            </div>
        </div>
        <div class="item item-3 img-item">
            <div class="carousel-caption-3">
            </div>
        </div>
        <div class="item item-4 img-item">
            <div class="carousel-caption-4">
            </div>
        </div>
        <div class="item item-5 img-item">
            <div class="carousel-caption-5">
            </div>
        </div>
    </div>
    <a class="left carousel-control" href="#myCarousel" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"><img src="<?php  echo Yii::app()->theme->baseUrl; ?>/<?php // echo Yii::app()->theme->baseUrl; ?>/images/banner_left.png" /></span></a>
    <a class="right carousel-control" href="#myCarousel" data-slide="next"><span class="glyphicon glyphicon-chevron-right"><img src="<?php  echo Yii::app()->theme->baseUrl; ?>/<?php // echo Yii::app()->theme->baseUrl; ?>/images/banner_right.png" /></span></a>
</div>
...
<div class="container marketing">
    ...
    <div class="row">
        ...
        $this->renderPartial("//default/_apps", array("cat" => $categories[0]));*/
        ?>
 ...
 array('data-ajax' => 'false')); ?>
            ...
            <p><?php echo CHtml::link(CHtml::image(Yii::app()->theme->baseUrl . "/images/more_button.jpg"),$this->createUrl("default/underConstruction"), 
                    array('data-ajax' => 'false')); ?></p>
        </div>


        <?php
        //$this->renderPartial("//default/_ebooks", array("cat" => $categories[1]));
        ?>
        ...
        <script src="<?php  echo Yii::app()->theme->baseUrl; ?>/sliderlayer/jquery.js" type="text/javascript"></script>
        <script src="<?php  echo Yii::app()->theme->baseUrl; ?>/js/jquery-easing-1.js" type="text/javascript"></script>
        <script src="<?php  echo Yii::app()->theme->baseUrl; ?>/js/jquery-transit-modified.js" type="text/javascript"></script>
        <script src="<?php  echo Yii::app()->theme->baseUrl; ?>/js/layerslider.js" type="text/javascript"></script>
        <script src="<?php  echo Yii::app()->theme->baseUrl; ?>/js/layerslider_002.js" type="text/javascript"></script>
        <script type="text/javascript">
            $(document).ready(function(){
                $('#layerslider').layerSlider({
                    skinsPath : '<?php  echo Yii::app()->theme->baseUrl; ?>/sliderlayer/skins/',
                    skin : 'glass',
