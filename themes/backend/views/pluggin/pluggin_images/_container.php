        ...
        <div class="main">
            ...
            <div class="form_body">
                <div class="grid_title col-lg-12">
                    <div class="title col-lg-5" ><?php echo CHtml::activeLabelEx($relateModelobj, 'image_large'); ?></div>
                    <div class="title col-lg-4" ><?php echo CHtml::activeLabelEx($relateModelobj, 'is_default'); ?></div>
                    <div class="title col-lg-2" ><?php echo CHtml::activeLabelEx($relateModelobj, 'tag'); ?></div>
